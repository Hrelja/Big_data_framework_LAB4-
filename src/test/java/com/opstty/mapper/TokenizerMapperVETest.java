...
public class TokenizerMapperVETest {
    @Mock
    private Mapper.Context context;
    private TokenizerMapperVE tokenizerMapper;

    @Before
    public void setup() {
        this.tokenizerMapper = new TokenizerMapperVE();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        verify(this.context, times(1))
                .write(new Text("10"), new IntWritable(1));
    }
}