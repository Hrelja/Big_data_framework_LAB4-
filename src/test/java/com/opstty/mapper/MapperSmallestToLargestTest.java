...
public class MapperSmallestToLargestTest {
    @Mock
    private Mapper.Context context;
    private MapperSmallestToLargest tokenizerMapper;

    @Before
    public void setup() {
        this.tokenizerMapper = new MapperSmallestToLargest();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        verify(this.context, times(1))
                .write(new Text("fraxinifolia"), new IntWritable(22));
    }
}