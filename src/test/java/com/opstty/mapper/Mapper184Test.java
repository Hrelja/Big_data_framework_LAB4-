...
public class Mapper184Test {
    @Mock
    private Mapper.Context context;
    private Mapper184 tokenizerMapper;

    @Before
    public void setup() {
        this.tokenizerMapper = new Mapper184();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        String value = "GEOPOINT;ARRONDISSEMENT;GENRE;ESPECE;FAMILLE;ANNEE PLANTATION;HAUTEUR;CIRCONFERENCE;ADRESSE;NOM COMMUN;VARIETE;OBJECTID;NOM_EV\n" +
                ...
                "(48.857140829, 2.29533455314);7;Maclura;pomifera;Moraceae;1935;16.0;;Quai Branly, avenue de La Motte-Piquet, avenue de la Bourdonnais, avenue de Suffren;Oranger des Osages;;6;Parc du Champs de Mars\n" +
                ...
                "(48.8768191638, 2.33210374339);10;Pterocarya;fraxinifolia;Juglandaceae;1862;22.0;330.0;Place d'Estienne-d'Orves;Pérocarya du Caucase;;14;Square Etienne d'Orves";

        this.tokenizerMapper.map(null, new Text(value), this.context);

        verify(this.context, times(1))
                .write(new Text("pomifera"), new IntWritable(16));
    }
}